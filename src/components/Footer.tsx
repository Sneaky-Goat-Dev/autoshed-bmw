...
const footerNavigation = {
  vehicles: [
    ...
    { name: 'Porsche', href: '/vehicles?make=Porsche' },
    { name: 'Land Rover', href: '/vehicles?make=Land%20Rover' },
  ],
  services: [
    { name: 'Vehicle Finance', href: '/finance' },
    { name: 'Sell Your Car', href: '/sell-your-car' },
    { name: 'Trade-In', href: '/contact' },
    { name: 'Nationwide Delivery', href: '/contact' },
  ],
  company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-silver text-sm leading-relaxed mb-6 max-w-md">
              {business.description}. With over 28 years of experience and 70% repeat business,
              we are your trusted partner for premium vehicles.
            </p>
          ...
          {/* Vehicles Column */}
          <div>
            <h3 className="text-sm font-black uppercase tracking-wider mb-4">Vehicles</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-silver text-sm">
              <li>
                <a href={`tel:${contact.phones[0].replace(/\s/g, '')}`} className="hover:text-white transition-colors">
                  {contact.phones[0]}
                </a>
              </li>
              <li>
            ...
            <a
              href="https://wa.me/27776005558?text=Hi%20The%20Auto%20Shed%2C%20I%27d%20like%20more%20information."
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-flex items-center gap-2 px-4 py-2.5 bg-[#25D366] text-white text-sm font-bold hover:bg-[#1FB855] transition-colors"
              aria-label="Chat to The Auto Shed on WhatsApp"
            >
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-silver text-xs">
              {business.fsp} | Insurance Partner: {business.insurancePartner}
            </p>
          </div>
        </div>
      </div>
